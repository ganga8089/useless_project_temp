...
- *Libraries used*: - @tanstack/react-router (File-based Routing & State Management)
- @tanstack/react-query (Data fetching & state caching) - @tailwindcss/vite & tailwindcss v4 (Utility-first styling & design system)
